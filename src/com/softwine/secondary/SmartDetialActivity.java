...
public class SmartDetialActivity extends Activity {
    ...
    static {
        mDrawablesResIds = new int[] {R.drawable.house_first,
                R.drawable.smart_curtain_detail, R.drawable.smart_energy_detail,
                R.drawable.smart_light_detail, R.drawable.smart_media_detail,
        };
    }
