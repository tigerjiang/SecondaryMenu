...
public class GameAppsGridActivity extends Activity {

	private static final String TAG = GameAppsGridActivity.class
			.getSimpleName();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mTitleView.setText(R.string.game_title);
		...
		mFirstAppLayout.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				mFirstApp.startApplication(GameAppsGridActivity.this);
	...
	public void onAppManagerReady() {
		mAppList = mAppManager.getGameApplications();
		if (mAppList.size() == 0) {
			return;
		}
		mFirstApp = mAppList.get(0);
		mFirstAppIcon.setImageResource(R.drawable.game_first);
		...
		mGrid.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view,
				...
				mAppList.get(position).startApplication(
						GameAppsGridActivity.this);
			}
		});
	}
